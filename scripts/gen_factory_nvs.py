"""Generate the factory NVS partition CSV (serial number and ECDSA P-256 keypairs) consumed by `nvs_create_partition_image` to build the image flashed onto the `factory_data` partition."""
...
def main() -> None:
    ...
    parser.add_argument("--serial",
        help="Device serial to use instead of a random one.",
    )
